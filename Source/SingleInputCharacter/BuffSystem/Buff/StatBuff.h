...
public:
	...
	// Called to setup the buff with new stats after the buff has already been setup previously
	void SetupReBuff(int InBaseStat, float InMultiplier, float InDuration);
